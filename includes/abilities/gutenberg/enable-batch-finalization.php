...
wp_register_ability('novamira/gutenberg-enable-batch-finalization', [
    'label' => __('Enable Gutenberg Batch Finalization', domain: 'novamira'),
    'description' => __(
